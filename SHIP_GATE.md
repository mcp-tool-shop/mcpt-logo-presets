...
- [ ] `[cli|mcp|desktop]` SKIP: pure data library — no CLI or destructive actions
- [ ] `[cli|mcp|desktop]` SKIP: pure data library — no file operations
...
- [ ] `[mcp]` SKIP: not an MCP server
- [ ] `[complex]` SKIP: simple preset library — not complex
...
- [ ] `[all]` SKIP: no standalone logo — uses logo-studio branding
